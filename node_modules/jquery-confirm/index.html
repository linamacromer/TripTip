        ...
        somethingElse: {
            ...
            action: function(){
                ...
                <div class="section">
                    ...
                    <p class="text-info">
                        Available bootstrap options are <code>btn-primary</code> <code>btn-inverse</code> <code>btn-warning</code>
                        <code>btn-info</code> <code>btn-danger</code> <code>btn-success</code> or any other class name.
                    </p>
                    <button class="btn btn-primary example3-1">info, danger, warning, success!</button>
                    <script type="text/javascript">
